...
The package reads tree files directly, handles compound IQ-TREE labels, translates tip names between naming conventions, prunes to shared taxa, and produces publication-ready figures from R  no manual placement, no external software, no disposable scripts.

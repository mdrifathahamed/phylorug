...
*Hamonthophagus*, *Digitonthophagus*, and *Phalops* form an early-branching
grade, while the bulk of *Onthophagus* species form a large, densely
supported crown clade.
...
In contrast, the Proagoderus + Parascatonomus clade and the early-branching
*Kurtops*–*Hamonthophagus*–*Onthophagus probus*–*Digitonthophagus*–*Phalops*
grade are uniformly black across all analyses, indicating strong and
stable support regardless of method — exactly as the source study reports
with 100% support and filled dots at every node in this region.

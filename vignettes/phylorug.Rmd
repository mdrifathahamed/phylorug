...
(Psychodidae) and Coboldia fuscipes (Scatopsidae). Root on all
three, then drop them. The order matters — you must root while the
outgroup tips are still present, because ape::root() needs to find
them in the tree:
